...
(function($, window, document, undefined) {
  ...
  Timepicker.prototype = {
    ...
    decrementHour: function() {
      ...
      if(this.hour < 12){$('#cambiar').html("AM");}else{$('#cambiar').html("PM");}
	
	  if(this.hour < 12){ 
		 $('#meridiano_i').html('<input type="text" class="col-sm-6 col-md-1 col-lg-1 bg-light text-dark" readonly value="AM" />');
	  $("#cambiar2").removeClass("bg-dark text-light");
	  }else{
	  $("#cambiar2").addClass("bg-dark text-light");
	     $('#meridiano_i').html('<input type="text" class="col-sm-6 col-md-1 col-lg-1 bg-dark text-default" readonly value="PM" />');
	  }
    },
